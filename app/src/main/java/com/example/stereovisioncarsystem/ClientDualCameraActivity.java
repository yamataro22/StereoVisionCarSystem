...
public class ClientDualCameraActivity extends CommunicationBasicActivity implements ObservedRotatedCameraFramesCapturer.CameraFrameConnector {
    ...
    protected void getSavedCameraMatrix()
    {
    ...
    protected void sendMessageToServer(Object message) throws ClientDualCameraActivity.NullClientException
    {
    ...
    protected void enableCameraViewOnClient() {
    ...
    protected WifiP2pDevice getDeviceByName() {
    ...
    protected boolean isClientInDeviceArray() {
